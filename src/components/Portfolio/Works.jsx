    ...
    render() {
        return (
            ...
            <Container className="mt-5 pt-5 justify-content-center d-flex"> 
                ...
                <img src={this.props.work.picture1} style={{width: "100%", height: "280px", objectFit: "fill"}}/>
                </Col>
                <Col md={6} className="mt-2">
                    <img src={this.props.work.picture2} style={{width: "100%", height: "280px", objectFit: "fill"}}/>
